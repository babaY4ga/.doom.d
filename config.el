...
(setq doom-font (font-spec :family "Hack" :size 11 :weight 'semi-light)
      doom-variable-pitch-font (font-spec :family "Source Code Pro") ; inherits `doom-font''s :size
      doom-unicode-font (font-spec :family "Input Mono Narrow" :size 11)
      doom-big-font (font-spec :family "Merriweather" :size 16))
